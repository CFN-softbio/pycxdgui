...
class Calibration:
    ...
    def calc_from_XY(self, X, Y, calc_cor_factors=False):
        ...
        # matrix calculation RT.T[i] is a vector x0, y0 is considerence the
        # origin, which is also beam center
    ...
    def set_pixel_size(self, pixel_size_um=None, width_mm=None,
                       num_pixels=None):
        '''Sets the pixel size (in microns) for the detector. Pixels are
